export const MOMENTS_FORMATS = Object.freeze({
...
export const DATEFNS_FORMATS = Object.freeze({
...
const formatAsTaiwaneseDate = (date) => {
	const taiwaneseYear = date.getFullYear() - 1911;
	const month = date.getMonth() + 1;
	const day = date.getDate();
	return `${taiwaneseYear}/${month}/${day}`;
};

const Dates = {
	...MOMENTS_FORMATS,
	...DATEFNS_FORMATS,
	formatAsTaiwaneseDate,
};
