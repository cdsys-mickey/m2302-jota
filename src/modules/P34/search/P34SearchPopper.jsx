...
import P34SearchForm from "./P34SearchForm";
const P34SearchPopper = memo(
		...
		return (
			...
			<PopperBox width={width} ref={ref}>
				...
				<DialogContent {...ContentProps}>
					<P34SearchForm initSize="xs" spacing={2} />
				</DialogContent>
				<Divider />
				<DialogActions>
...
P34SearchPopper.displayName = "P34SearchPopper";

export default P34SearchPopper;
