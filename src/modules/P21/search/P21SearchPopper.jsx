...
import P21SearchForm from "./P21SearchForm";
const P21SearchPopper = memo(
		...
		return (
			...
			<PopperBox width={width} ref={ref}>
				...
				<DialogContent {...ContentProps}>
					<P21SearchForm initSize="xs" spacing={1} />
				</DialogContent>
				<Divider />
				<DialogActions>
...
P21SearchPopper.displayName = "P21SearchPopper";

export default P21SearchPopper;
