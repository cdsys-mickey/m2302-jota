...
const transformForReading = (payload) => {
	...
	return {
		...
		PreAmt: Forms.formatMoney(PreAmt),
		RcvAmt: Forms.formatMoney(RcvAmt),
		CollAmt: Forms.formatMoney(CollAmt),
		RemAmt: Forms.formatMoney(RemAmt),
		CashAmt: Forms.formatMoney(CashAmt),
		DnsAmt: Forms.formatMoney(DnsAmt),
		ChkAmt: Forms.formatMoney(ChkAmt),
		CutAmt: Forms.formatMoney(CutAmt),
		// 增加收沖差額
		DiffAmt: Forms.formatMoney(
			(Number(CollAmt) ?? 0) - (Number(CutAmt) ?? 0)
		),
