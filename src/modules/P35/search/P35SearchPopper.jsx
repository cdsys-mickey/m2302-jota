...
import P35SearchForm from "./P35SearchForm";
const P35SearchPopper = memo(
		...
		return (
			...
			<PopperBox width={width} ref={ref}>
				...
				<DialogContent {...ContentProps}>
					<P35SearchForm initSize="xs" spacing={2} />
				</DialogContent>
				<Divider />
				<DialogActions>
...
P35SearchPopper.displayName = "P35SearchPopper";

export default P35SearchPopper;
