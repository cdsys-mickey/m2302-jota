...
import G08SearchForm from "./G08SearchForm";
const G08SearchPopper = memo(
		...
		return (
			...
			<PopperBox width={width} ref={ref}>
				...
				<DialogContent {...ContentProps}>
					<G08SearchForm initSize="xs" spacing={2} />
				</DialogContent>
				<Divider />
				<DialogActions>
...
G08SearchPopper.displayName = "G08SearchPopper";

export default G08SearchPopper;
