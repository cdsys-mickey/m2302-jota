...
import P42SearchForm from "./P42SearchForm";
const P42SearchPopper = memo(
		...
		return (
			...
			<PopperBox width={width} ref={ref}>
				...
				<DialogContent {...ContentProps}>
					<P42SearchForm initSize="xs" spacing={2} />
				</DialogContent>
				<Divider />
				<DialogActions>
...
P42SearchPopper.displayName = "P42SearchPopper";

export default P42SearchPopper;
