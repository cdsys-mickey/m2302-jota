...
const P37DomesticTabViewComponent = (props) => {
	...
	return (
		<TabPanel value={CmsGroupTypes.Types.DOMESTIC} {...rest}>
...
P37DomesticTabViewComponent.propTypes = {
	editing: PropTypes.bool
}
const P37DomesticTabView = memo(P37DomesticTabViewComponent);
export default P37DomesticTabView;