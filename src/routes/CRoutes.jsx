...
import { C02FrameContainer } from "@/pages/jobs/C02/C02FrameContainer";
import { C01Provider } from "@/contexts/C01/C01Provider";
import { C01FrameContainer } from "@/pages/jobs/C01/C01FrameContainer";
import { C04Provider } from "@/contexts/C04/C04Provider";
import { C04FrameContainer } from "@/pages/jobs/C04/C04FrameContainer";
import { C03Provider } from "@/contexts/C03/C03Provider";
import { C03FrameContainer } from "@/pages/jobs/C03/C03FrameContainer";
import { InfiniteLoaderProvider } from "@/contexts/infinite-loader/InfiniteLoaderProvider";
import { C05FrameContainer } from "@/pages/jobs/C05/C05FrameContainer";
import { C06FrameContainer } from "@/pages/jobs/C06/C06FrameContainer";
import { C07FrameContainer } from "@/pages/jobs/C07/C07FrameContainer";
...
import { C08FrameContainer } from "../pages/jobs/C08/C08FrameContainer";
import { C09FrameContainer } from "../pages/jobs/C09/C09FrameContainer";
