...
const TypoLabelView = memo(
	forwardRef((props, ref) => {
		...
		return (
			<BoxComponent className={TypoLabelView.displayName} ref={ref} inline={inline} {...defaultBoxProps} {...slotProps?.box} sx={[
				(theme) => ({
					...(flex && {
						alignItems: "center"
					}),
				...
				<Box className="TypoLabelView-bodybox" sx={{
					...(dense && {
						position: "relative",
...
TypoLabelView.displayName = "TypoLabelView";
TypoLabelView.propTypes = {
