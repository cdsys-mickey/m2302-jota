...
const RecvAcctCurrentCustomerPicker = (props) => {
	...
	const url = useMemo(() => {
		return "v1/sales/recv-account/current-customers"
	}, [])
...
RecvAcctCurrentCustomerPicker.displayName = "RecvAcctCurrentCustomerPicker";
RecvAcctCurrentCustomerPicker.propTypes = {
...
export default RecvAcctCurrentCustomerPicker;