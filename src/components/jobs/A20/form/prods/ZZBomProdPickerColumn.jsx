...
const ZZBomProdPickerColumn = memo((props) => {
	const {
		name,
...
ZZBomProdPickerColumn.propTypes = {
...
ZZBomProdPickerColumn.displayName = "ZZBomProdPickerColumn";
export default ZZBomProdPickerColumn;
