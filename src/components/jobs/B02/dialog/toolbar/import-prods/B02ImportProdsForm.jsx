...
import { B02ImportProdsButtonContainer } from "./B02ImportProdsButtonContainer";

const B02LoadProdsForm = memo((props) => {
...
B02LoadProdsForm.propTypes = {
	handleSubmit: PropTypes.func,
};

B02LoadProdsForm.displayName = "B02LoadProdsForm";
export default B02LoadProdsForm;
