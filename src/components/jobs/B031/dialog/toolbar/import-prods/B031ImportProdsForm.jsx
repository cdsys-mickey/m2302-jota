...
import { B031ImportProdsButtonContainer } from "./B031ImportProdsButtonContainer";

const B031LoadProdsForm = memo((props) => {
			...
			<Box pt={1}>
				...
				<FlexToolbar align="right">
					<Tooltip title="shift+Enter">
						<B031ImportProdsButtonContainer
							variant="contained"
							color="primary"
						/>
					</Tooltip>
...
B031LoadProdsForm.propTypes = {
	onSubmit: PropTypes.func,
};

B031LoadProdsForm.displayName = "B031LoadProdsForm";
export default B031LoadProdsForm;
